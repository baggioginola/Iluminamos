...
class UserModel extends Database
{
    ...
    public function getAll()
    {
        ...
        $query = "SELECT id_usuario,nombre,apellidos,e_mail FROM " . self::$table . " WHERE status = true";
    ...
    public function getById($id = '')
    {
        ...
        $query = "SELECT id_usuario,nombre,apellidos,e_mail,password,nivel FROM " . self::$table . " WHERE id_usuario = '" . $id . "' ";
